<template>
	<p class="control is-expanded">
      ...
      <textarea class="textarea" :class="{'is-success': isSaved, 'is-danger': isDirty}"  :placeholder="placeholder" :name="name" v-model="value" @blur="updateField" @keyup="dirtyCheck"></textarea>
    </p>
</template>
