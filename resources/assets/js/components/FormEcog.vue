<template>
	<article class="message is-info">
		...
		<div class="message-body">
			<div class="field">
				<input class="is-checkradio" id="ecog1" type="radio" v-model="ecog" value="1" :class="{'is-success': isSuccess, 'is-danger': !isSuccess}" @change="updateEcog">
			...
			<div class="field">
				<input class="is-checkradio" id="ecog4" type="radio" v-model="ecog" value="4" :class="{'is-success': isSuccess, 'is-danger': !isSuccess}" @change="updateEcog">
		        <label for="ecog4">Capable of only limited selfcare; confined to bed or chair more than 50% of waking hours</label>	
			</div>
			<div class="field">
				<input class="is-checkradio" id="ecog5" type="radio" v-model="ecog" value="5" :class="{'is-success': isSuccess, 'is-danger': !isSuccess}" @change="updateEcog">
		        <label for="ecog5">Completely disabled; cannot carry on any selfcare; totally confined to bed or chair</label>	
			</div>
			<div class="field">
				<input class="is-checkradio" id="ecog6" type="radio" v-model="ecog" value="6" :class="{'is-success': isSuccess, 'is-danger': !isSuccess}" @change="updateEcog">
